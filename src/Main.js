...
var player2;
  inicio[0].onclick = function() {
    if(player ===1){ player1 = "./img/Clay"
    player++
    choose[0].innerText= choose2
   
  }
    else if(player ===2){ player2 = "./img/Clay"
    player++
  ...
  inicio[1].onclick = function() {
    if(player ===1){ player1 = "./img/Jane"
    player++
    choose[0].innerText= choose2
  }
    else if(player ===2){ player2 = "./img/Jane"
    player++
    inicio[4].classList.remove("buttonsOf")
    choose[0].innerText= play
  }
  ...
  inicio[2].onclick = function() {
    if(player ===1){ player1 = "./img/Jebediah"
    player++
    choose[0].innerText= choose2
  }
    else if(player ===2){ player2 = "./img/Jebediah"
    player++
    inicio[4].classList.remove("buttonsOf")
    choose[0].innerText= play
  }
  ...
  inicio[3].onclick = function()  {
    if(player ===1){ player1 = "./img/Ahusaka"
    player++
    choose[0].innerText= choose2
  }
    else if(player ===2){ player2 = "./img/Ahusaka"
    player++
    inicio[4].classList.remove("buttonsOf")
    choose[0].innerText= play
  }
